function[OUT,pearson_residuals,pred,probability,meany,rpit,confidence_interval]=output_parx_rob_simu(y,X,theta0,p,q,s,filename,omega, alpha, beta, gamma)
